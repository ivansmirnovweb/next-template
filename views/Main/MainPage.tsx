...
export const MainPage = () => {
  return (
    <section className="flex items-center relative isolate min-h-[calc(100svh-12rem)] overflow-hidden border border-border/70 bg-card/70 py-10 shadow-sm backdrop-blur-sm sm:py-14 lg:py-16">
      ...
      <div className="layout-container relative z-10">
        <div className="grid w-full items-center gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
